...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'devel.http_middleware' => 'getDevel_HttpMiddlewareService',
            ...
            'logger.syslog' => 'getLogger_SyslogService',
    ...
    /**
     * Gets the 'devel.http_middleware' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\devel\StackMiddleware\DevelMiddleware A Drupal\devel\StackMiddleware\DevelMiddleware instance.
     */
    protected function getDevel_HttpMiddlewareService()
    {
        $this->services['devel.http_middleware'] = $instance = new \Drupal\devel\StackMiddleware\DevelMiddleware($this->get('http_middleware.reverse_proxy'), $this->get('config.factory'));

        $instance->_serviceId = 'devel.http_middleware';
    ...
    protected function getHttpKernelService()
    {
        ...
        $this->services['http_kernel'] = $instance = new \Stack\StackedHttpKernel($a, array(0 => $a, 1 => $this->get('devel.http_middleware'), 2 => $this->get('http_middleware.reverse_proxy'), 3 => $this->get('http_middleware.page_cache'), 4 => $this->get('http_middleware.kernel_pre_handle'), 5 => $this->get('http_middleware.session'), 6 => $this->get('http_kernel.basic')));
    ...
    {
        $this->services['http_middleware.negotiation'] = $instance = new \Drupal\Core\StackMiddleware\NegotiationMiddleware($this->get('devel.http_middleware'), $this->get('http_negotiation.format_negotiator'));
    ...
    {
        $this->services['language.default'] = $instance = new \Drupal\Core\Language\LanguageDefault(array('uuid' => '77b43293-9130-462f-8906-6fe0d53483b0', 'langcode' => 'ja', 'status' => true, 'dependencies' => array(), 'id' => 'en', 'label' => 'English', 'direction' => 'ltr', 'weight' => -10, 'locked' => false));
    ...
    protected function getLogger_FactoryService()
    {
        ...
        $instance->setContainer($this);
        $instance->addLogger($this->get('logger.syslog'), 0);
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\syslog\Logger\SysLog A Drupal\syslog\Logger\SysLog instance.
     */
    protected function getLogger_SyslogService()
    {
        $this->services['logger.syslog'] = $instance = new \Drupal\syslog\Logger\SysLog($this->get('config.factory'), $this->get('logger.log_message_parser'));

        $instance->_serviceId = 'logger.syslog';
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'devel_node_access' => array(
                    'type' => 'module',
                    'pathname' => 'modules/contrib/devel/devel_node_access/devel_node_access.info.yml',
                    'filename' => 'devel_node_access.module',
                ),
                'editor' => array(
                    'type' => 'module',
                ...
                'picture_manager' => array(
                    'type' => 'module',
                    'pathname' => 'modules/custom/picture_manager/picture_manager.info.yml',
                    'filename' => 'picture_manager.module',
                ),
                'quickedit' => array(
                    'type' => 'module',
                ...
                'syslog' => array(
                    'type' => 'module',
                    'pathname' => 'core/modules/syslog/syslog.info.yml',
                    'filename' => 'syslog.module',
                ),
                'system' => array(
                    'type' => 'module',
            ...
            'container.namespaces' => array(
                ...
                'Drupal\\devel_node_access' => 'modules/contrib/devel/devel_node_access/src',
                ...
                'Drupal\\picture_manager' => 'modules/custom/picture_manager/src',
                ...
                'Drupal\\syslog' => 'core/modules/syslog/src',
            ...
            'language.default_values' => array(
                'uuid' => '77b43293-9130-462f-8906-6fe0d53483b0',
                'langcode' => 'ja',
                'status' => true,
                'dependencies' => array(
